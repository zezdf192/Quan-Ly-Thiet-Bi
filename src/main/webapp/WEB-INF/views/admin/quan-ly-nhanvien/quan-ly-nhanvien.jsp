...
<body>
	<div class="manage-body" style="min-height: 600px">
				...
				<div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
					<div id="liveToast2" class="toast hide" role="alert"
						...
						<div class="toast-header bg-success">
							<i class="bi bi-exclamation-octagon"></i> <strong class="me-auto">THÀNH CÔNG</strong>
							<button type="button" class="btn-close" data-bs-dismiss="toast"
								aria-label="Close"></button>
						</div>
							...
							<tr>
								...
								<td class="action"
									...
									<button type="button" class="btn btn-danger btn-delete"
										...
										data-bs-whatever="${item.maNV},${item.taiKhoan}">Xóa</button>
								</td>
							</tr>
						</c:forEach>
					</tbody>
						...
						<form:form
							...
							<div class="col-md-12">
								<label for="manv" class="form-label">Mã nhân viên</label> <input
									name="maNV" type="text" class="form-control" required />
							</div>
							<div class="col-md-12">
								<label for="tennv" class="form-label">Họ và tên</label> <input
									name="tenNV" type="text" class="form-control" required />
							</div>
							<div class="col-12">
								<label for="cmnd" class="form-label">CMND</label> <input
									name="CMND" type="text" class="form-control" required />
							</div>
							<div class="col-12">
		...
		<div class="modal fade" id="inforFormStaff" tabindex="-1"
			...
			<div class="modal-dialog ">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">THÔNG TIN NHÂN
							VIÊN</h5>
						<button type="button" class="btn-close" data-bs-dismiss="modal"
							aria-label="Close"></button>
					</div>
					<div class="modal-body">
						<form:form id="showInforForm" class="row g-3" method="GET"
							action="" modelAttribute="nhanvien">
							<div class="col-md-12">
								<label for="manv" class="form-label">Mã nhân viên</label> <input
									name="maNV" type="text" class="form-control" id="maNVInput"
									disabled="true" />
							</div>
							<div class="col-md-12">
								<label for="tennv" class="form-label">Họ và tên</label> <input
									name="tenNV" type="text" class="form-control" id="tenNVInput"
									disabled="true" />
							</div>
							<div class="col-12">
								<label for="cmnd" class="form-label">CMND</label> <input
									name="CMND" type="text" class="form-control" id="CMNDInput"
									disabled="true" />
							</div>
							<div class="col-12">
								<label for="email" class="form-label">Email</label> <input
									name="email" type="email" class="form-control" id="emailInput"
									disabled="true" />
							</div>
							<div class="col-md-12">
								<label for="sdt" class="form-label">Số điện thoại</label> <input
									name="sdt" type="text" class="form-control" id="sdtInput"
									disabled="true" />
							</div>
						...
						<form:form id="addAccountForm" action="" class="row g-3"
							...
							<div class="col-md-12">
								<label for="matKhau" class="form-label">Mật khẩu</label> <input
									name="matKhau" type="text" class="form-control" required />
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form:form id="updateForm" action="" class="row g-3"
							...
							<div class="col-md-12">
								<label for="manv" class="form-label">Mã nhân viên</label> <input
									name="maNV" class="form-control" id="manv" required readonly />
							</div>
							<div class="col-md-12">
								<label for="tennv" class="form-label">Họ và tên</label> <input
									name="tenNV" class="form-control" id="tennv" required />
							</div>
							<div class="col-12">
								<label for="cmnd" class="form-label">CMND</label> <input
									name="CMND" class="form-control" id="cmnd" required readonly />
							</div>
							<div class="col-12">
								<label for="email" class="form-label">Email</label> <input
							...
							<div class="col-md-12">
								<label for="sdt" class="form-label">Số điện thoại</label> <input
									name="sdt" class="form-control" id="sdt" required />
							</div>
							<div class="col-md-12">
    ...
    document.querySelectorAll('.btn-delete').forEach(button => {
        button.addEventListener('click', function () {
        	...
        	var maNV = values[0];
        	var taiKhoan = values[1];
        	
            document.getElementById('deleteForm').action = "/QuanLyThietBi/quan-tri/quan-ly-nhanvien/xoa-nhanvien/" + maNV + ";" + taiKhoan;
    ...
    document.querySelectorAll('.btn-update').forEach(button => {
        button.addEventListener('click', function () {
            ...
            updateForm.action = "/QuanLyThietBi/quan-tri/quan-ly-nhanvien/sua-tt-nhanvien/" + maNV;
    ...
    if (errorMessage) {
        var toast1 = new bootstrap.Toast(document.getElementById('liveToast1'));
        toast1.show();
    }
    
    var message = "<%=request.getSession().getAttribute("message")%>";
   	if (message) {
        var toast2 = new bootstrap.Toast(document.getElementById('liveToast2'));
       	toast2.show();
   	}
</script>
<script>
